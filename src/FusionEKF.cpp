  ...
  if (!is_initialized_) {
    ...
    */
    ...
    if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
      ...
      */
    float rho = measurement_pack.raw_measurements_[0];         //range - The radial distance from origin
    float phi = measurement_pack.raw_measurements_[1];         //bearing - Angle between rho and x-axis
    float rho_dot = measurement_pack.raw_measurements_[2];     //radial velocity - rate of change of rho
